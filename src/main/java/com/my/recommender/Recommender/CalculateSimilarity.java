...
public class CalculateSimilarity {
    ...
    public static double EuclidDist(Map<String, Double> userMap1, Map<String, Double> userMap2, Set<String> userSet,
            Set<String> itemSet) {
        double sum = 0;
    ...
    // 余弦相似度找邻居
    public static double CosineDist(Map<String, Double> userMap1, Map<String, Double> userMap2, Set<String> userSet,
            Set<String> itemSet) {
        double dist = 0;
    ...
    public static double execute(Map<String, Double> userMap1, Map<String, Double> userMap2, Set<String> userSet,
            Set<String> itemSet) {
    ...
    public static void execute(String userId, Map<String, Map<String, Double>> scoreTable, Set<String> userSet,
            Set<String> itemSet) {
    ...
    public static void execute(Map<String, Map<String, Double>> scoreTable, Set<String> userSet, Set<String> itemSet) {

...
public class ParseTool {
    ...
    public static User parseUser(String[] contents) {
        ...
        /*
         * // 2.调用CountFileTest需放开，其它需注释 if (contents[2] != null &&
         * !contents[2].isEmpty()) {
         * user.setBehaviorType(Integer.valueOf(contents[2].trim())); }
         * 
         * // 2.调用CountFileTest需放开，其它需注释 if (contents[n-1] != null &&
         * !contents[n-1].isEmpty()) {
        ...
        /*
         * // 1.调用SpliteFileAndMakeScoreTable需放开，其它需注释 if (contents[3] != null &&
         * !contents[3].isEmpty()) { user.setUserGeoHash(contents[3].trim()); } if
         * (contents[4] != null && !contents[4].isEmpty()) {
         * user.setItemCategory(contents[4].trim()); } if (contents[5] != null &&
         * !contents[5].isEmpty()) { user.setTime(contents[5].trim()); }
         */
        return user;
    }
